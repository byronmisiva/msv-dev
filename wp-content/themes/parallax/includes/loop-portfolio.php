...
<article id="post-<?php the_ID(); ?>" <?php post_class("thumbnail post clearfix portfolio-post" . $themify->theme->get_categories_as_classes(get_the_ID())); ?>>
	...
	<?php } elseif( $post_image = themify_get_image('ignore=true&'.$themify->auto_featured_image . $themify->image_setting . "w=".$themify->width."&h=".$themify->height) ) { ?>
		<?php if($themify->hide_image != 'yes') { ?>			
			<div class="caption-experiencias" <?php echo $themify->image_align; ?>>
				<img alt="" src=" <?php echo $cfs->get('featured_image_hover');?>">
			</div>
