...
<button type="submit" accesskey="p" tabindex="5" id="publish" class="btn btn-success btn-block btn-lg" name="publish"><i class="fa fa-save" id="psp"></i> &nbsp; <?php echo $_GET['task']=='EditPackage'?__('Update Package','wpdmpro'):__('Create Package','wpdmpro'); ?></button>
